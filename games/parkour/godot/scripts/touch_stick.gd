...
func _draw() -> void:
	var center := size * 0.5
	draw_circle(center, minf(size.x, size.y) * 0.45, Color(0.04, 0.12, 0.17, 0.32))
	draw_arc(center, minf(size.x, size.y) * 0.45, 0.0, TAU, 40, Color("74f1d0"), 2.0, true)
	draw_circle(handle, minf(size.x, size.y) * 0.20, Color(0.29, 0.83, 0.75, 0.82))
	draw_arc(handle, minf(size.x, size.y) * 0.20, 0.0, TAU, 28, Color("e8fff8"), 1.5, true)
