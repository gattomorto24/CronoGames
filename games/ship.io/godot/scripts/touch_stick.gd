...
func _draw() -> void:
	var center := size * 0.5
	draw_circle(center, minf(size.x, size.y) * 0.45, Color(0.15, 0.1, 0.29, 0.28))
	draw_arc(center, minf(size.x, size.y) * 0.45, 0.0, TAU, 40, Color("b68cff"), 2.0, true)
	draw_circle(handle, minf(size.x, size.y) * 0.20, Color(0.63, 0.49, 1.0, 0.82))
	draw_arc(handle, minf(size.x, size.y) * 0.20, 0.0, TAU, 28, Color("ede4ff"), 1.5, true)
